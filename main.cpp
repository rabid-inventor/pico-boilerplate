...
#define WIFI_SSID "TheGoodShipPimoroni"
#define WIFI_PASSWORD "nosuchthingas"
...
int main() {
    ...
    cyw43_arch_enable_sta_mode(); //setup wifi isn station mode 

    bool wifi_connected=false;
    while (!wifi_connected){
        cyw43_arch_gpio_put(CYW43_WL_GPIO_LED_PIN, 1);
        printf("connecting to access point");
        if(cyw43_arch_wifi_connect_timeout_ms(WIFI_SSID, WIFI_PASSWORD, CYW43_AUTH_WPA2_AES_PSK, 500000) ){
            printf("Wifi error retry in 2 secs");
